...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		if (mysql_num_rows($result) > 0) {
			...
			$sql = "INSERT INTO usuarios (nome,sobrenome,email,login,senha,UltimoLogon) VALUES('$nome','$sobrenome','$email','$login','$senha','$senha')";
	...
	<div id="global">
		...
		<div id="principal">
			...
			<div id="caixa_form">
				...
				<div id="linha_form">
					<div id="label"> <span class="label_fonte">Confirmação Senha: </span> </div><input type="password" size="20" name="senha2" class="form_style">
				</div>		 
