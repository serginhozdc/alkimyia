...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		alert("Algum campo foi preenchido incorretamente ou está em branco, tente novamente!");
			...
			$sql = "UPDATE estrutura SET  texto='$texto' WHERE id=1";			
					
			// Confirmacao de insert
			if (mysql_query($sql)) {
				alert("Texto Estrutura atualizado com sucesso!");
				redireciona("estrutura_cadastra.php?alterar=1");
			}
	}
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="estrutura_cadastra.php?cadastra=1" method="post" name="cadastro" enctype="multipart/form-data">
