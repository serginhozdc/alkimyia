...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		alert("Algum campo foi preenchido incorretamente ou est em branco, tente novamente!");
			...
			$sql = "UPDATE institucional SET  texto='$texto' WHERE id=1";			
					
			// Confirmacao de insert
			if (mysql_query($sql)) {
				alert("Texto Institucional atualizado com sucesso!");
				redireciona("institucional_cadastra.php?alterar=1");
			}
	}
...
if ($_REQUEST["alterar"]) {
    ...
    $sql = "SELECT * FROM institucional WHERE id=1";
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="institucional_cadastra.php?cadastra=1" method="post" name="cadastro" enctype="multipart/form-data">
