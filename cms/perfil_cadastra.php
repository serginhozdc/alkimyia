...
if ($_REQUEST['cadastra']) {
	...
	if (!$ok) {
		...
		alert("Algum campo foi preenchido incorretamente ou está em branco, tente novamente!");
			...
			$sql = "INSERT INTO sensei(nome,descricao,img) VALUES('$nome','$texto','$arquivo')";			
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="perfil_cadastra.php?cadastra=1" method="post" name="cadastro" enctype="multipart/form-data">
			...
			<div id="caixa_table">
				...
				<?
					$sql = "SELECT * FROM sensei ORDER BY id";
				...
				?>					
					<tr height="30" class="cel_fonte" onMouseOver="this.className='cel_fonte_hover'" onMouseOut="this.className='cel_fonte'">
						...
						<td align="center" width="1%" nowrap="nowrap">
							<a href="perfil_cadastra_alt.php?edit=1&cod=<?=$linha["id"]?>"><img src="images/icon_editar.gif" alt="Editar" border="0"></a>
							<a href="perfil_cadastra.php?apagar=1&cod=<?=$linha["id"]?>"><img src="images/icon_apagar.gif" onclick="javascript: return confirm('Deseja realmente excluir a imagem?')" alt="Apagar" border="0"></a></td>
					</tr>
				<?
				}
				?>
