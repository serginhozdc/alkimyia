...
if ($_REQUEST['apagar']) {
	...
	$sql = "DELETE FROM  fotos_estrutura WHERE id=".$_REQUEST['cod'];
	if (mysql_query($sql)) {
		alert("foto excluída com sucesso!");
		redireciona("estrutura_cadastra_fotos.php");
	}
...
if ($_REQUEST['cadastra']) {
	...
	//PARA REDIMENSIONAR IMAGENS >>>>   WideImage::loadFromFile($dir."\\".$arquivo)->resize(964,400,'fill','any')->saveToFile($dir."\\".$arquivo);
			...
			$sql = "INSERT INTO fotos_estrutura (img) VALUES ('$arquivo')";			
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="estrutura_cadastra_fotos.php?cadastra=1" method="post" name="cadastro" enctype="multipart/form-data">
			...
			<div id="caixa_table">
				...
				<?
					$sql = "SELECT * FROM fotos_estrutura ORDER BY id";
				...
				?>					
					<tr height="30" class="cel_fonte" onMouseOver="this.className='cel_fonte_hover'" onMouseOut="this.className='cel_fonte'">
						...
						<td align="center" width="1%" nowrap="nowrap">
							<a href="estrutura_cadastra_fotos.php?apagar=1&cod=<?=$linha["id"]?>"><img src="images/icon_apagar.gif" onclick="javascript: return confirm('Deseja realmente excluir a imagem?')" alt="Apagar" border="0"></a></td>
					</tr>
				<?
				}
				?>
