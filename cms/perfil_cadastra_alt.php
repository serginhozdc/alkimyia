...
if ($_REQUEST['edita']) {
	...
	if (!$ok) {
		...
		alert("Algum campo foi preenchido incorretamente ou está em branco, tente novamente!");
			...
			$sql = "UPDATE sensei SET $update_img nome='$nome' , descricao='$texto' WHERE id=".$_REQUEST['cod'];			
			//echo $sql;
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="perfil_cadastra_alt.php?edita=1&cod=<?=$id?>" method="post" name="cadastro" enctype="multipart/form-data">
