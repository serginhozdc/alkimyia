...
if ($_REQUEST['apagar']) {
	...
	$sql = "DELETE FROM  eventos WHERE id=".$_REQUEST['cod'];
	if (mysql_query($sql)) {
...
if ($_REQUEST['cadastra']) {
	...
	//PARA REDIMENSIONAR IMAGENS >>>>   WideImage::loadFromFile($dir."\\".$arquivo)->resize(964,400,'fill','any')->saveToFile($dir."\\".$arquivo);
			...
			$sql = "INSERT INTO eventos (nome,descricao,breve,data,img) VALUES ('$nome','$descricao','$breve','$data','$arquivo')";			
...
<br><br><br></div>
	...
	<div id="global">
		...
		<div id="principal">
			...
			<form action="eventos_cadastra.php?cadastra=1" method="post" name="cadastro" enctype="multipart/form-data">
			...
			<div id="caixa_form">
				...
				<div id="linha_form">
					<div id="label"> <span class="label_fonte">Breve: </span> </div><input type="text" size="50" maxlength="255" name="breve" class="form_style">
				</div>
				
				<div id="linha_form">
					<div id="label"> <span class="label_fonte">Data: </span> </div><input type="text" size="10" id="date" name="data" class="form_style">
				</div>
				
				<div id="linha_form">
					<div id="label"> <span class="label_fonte">Descrição: </span> </div><textarea rows="8" cols="50"  name="descricao" class="form_style"></textarea>
				</div>
				<br/>
				<br/>
				<br/>
				...
				?>					
					<tr height="30" class="cel_fonte" onMouseOver="this.className='cel_fonte_hover'" onMouseOut="this.className='cel_fonte'">
						...
						<td align="center" width="1%" nowrap="nowrap">
							<a href="eventos_cadastra_fotos.php?cod=<?=$linha["id"]?>"><img src="images/icon_imagem.gif" alt="Adicionar Fotos" border="0"></a>
							<a href="eventos_cadastra_alt.php?edita=1&cod=<?=$linha["id"]?>"><img src="images/icon_editar.gif" alt="Editar" border="0"></a>
							<a href="eventos_cadastra.php?apagar=1&cod=<?=$linha["id"]?>"><img src="images/icon_apagar.gif" onclick="javascript: return confirm('Deseja realmente excluir o Evento?')" alt="Apagar" border="0"></a></td>
